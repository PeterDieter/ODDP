...
if __name__ == "__main__":
    create_instance(fileName = "zip", limit=900, couriersPerWarehouse=8, pickersPerWarehouse=3, meanComissionTime=180, meanServiceTimeAtClient=120, gridStepSize=1000)
