...
if __name__ == "__main__":
    create_instance(fileName = "instance_zip", limit=900, couriersPerWarehouse=10, pickersPerWarehouse=3, meanComissionTime=180, meanServiceTimeAtClient=60, gridStepSize=1000)
